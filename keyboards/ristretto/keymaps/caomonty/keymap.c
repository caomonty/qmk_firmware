...
#define SF_UN RSFT_T(KC_INT2) // shift when held, underscore when tapped
...
#define BSLS A(KC_INT1)  // backslash
#define PIPE S(KC_INT1) // pipe
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
     ...
     */
     [_DIGITS] = LAYOUT(
      _______ , _______ , _______ , _______ , _______ , _______           , KC_INT1 , KC_P7   , KC_P8   , KC_P9   , KC_PSLS , _______ ,
     ...
     */
     [_WMANAGE] = LAYOUT(
      ...
      KC_LSFT , KC_Z    , KC_X    , KC_C    , KC_V    , KC_B              , KC_N    , KC_M    , KC_COMM , KC_DOT  , KC_SLSH , KC_INT2   ,
